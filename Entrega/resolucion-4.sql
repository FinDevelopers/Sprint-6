...
--hacer una transferencia de 1000$desde la cuenta 200 a la cuenta 400o Registrar el movimiento en la tabla movimientos
...
--(ponemos END TRANSACTION porque sino tira error)
END TRANSACTION;
BEGIN TRANSACTION;
